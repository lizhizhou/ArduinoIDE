...
#download program
spawn scp -r index.html $lophilo_user@$lophilo_address:$lophilo_path
set timeout 50
expect "password:"
set timeout 50
...
send "exit\r"
expect eof
spawn scp -r server.js $lophilo_user@$lophilo_address:$lophilo_path
set timeout 50
expect "password:"
set timeout 50
send "$lophilo_password\r"
...
send "exit\r"
expect eof
spawn scp -r src $lophilo_user@$lophilo_address:$lophilo_path
set timeout 50
expect "password:"
set timeout 50
send "$lophilo_password\r"
